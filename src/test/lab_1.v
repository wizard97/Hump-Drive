...
intros d premise.
destruct d. 
simpl in premise. discriminate.
simpl in premise. discriminate.
simpl. trivial.
simpl in premise. discriminate.
simpl in premise. trivial.
simpl in premise. discriminate.
simpl in premise. discriminate.
simpl in premise. discriminate.
...
Theorem nil_implies_tlopt_none :
  ...
  Proof.
  intros A lst premise. destruct lst as [| h t].
  simpl. trivial.
  discriminate.
  Qed.
...
Proof.
  intros A h t lst premise.
  destruct lst as [| h1 t1].
  discriminate.
  rewrite -> premise. simpl. trivial.
Qed.
