...
let test () =
  ...
  (* let l1 = encrypt_and_chunk "" pu in
  *)
  let l1 = encrypt_and_chunk "AAAAA" pu in
  "After encryption: "^l1 |> print_endline;
  let l2 = decrypt_chunked l1 pu pr in
  "After Decryption: "^l2 |> print_endline;
  print_int (String.length l2)
(*
